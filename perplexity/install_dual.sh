...
PROJECT_NAME="ai-unix-log-agent-dual"

echo "Creating dual-API project: ${PROJECT_NAME}"
...
echo "Installing dependencies (OpenAI + Gemini)..."
npm install dotenv openai @google/generative-ai yargs >/dev/null

echo "Writing package.json..."
cat > package.json << 'EOF'
{
  "name": "ai-unix-log-agent-dual",
  "version": "1.0.0",
  "description": "Agentic Node.js: Unix commands as AI tools (OpenAI + Gemini)",
  "main": "src/index.js",
  "type": "commonjs",
  "scripts": {
    "start": "node src/index.js",
    "start:openai": "API_PROVIDER=openai node src/index.js",
    "start:gemini": "API_PROVIDER=gemini node src/index.js",
...
cat > .env.example << 'EOF'
# Choose ONE provider by setting API_PROVIDER=openai OR API_PROVIDER=gemini
API_PROVIDER=openai

# OpenAI (if API_PROVIDER=openai)
OPENAI_API_KEY=sk-...

# Gemini (if API_PROVIDER=gemini) - get from https://aistudio.google.com/app/apikey
